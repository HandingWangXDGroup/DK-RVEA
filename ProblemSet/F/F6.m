classdef F6 < handle
    methods (Static = true)
        ...
        function PopObj = obj(PopDec)
            ...
            I1 = LineD(1:2:end);
            I2 = LineD(2:2:end);
            a  = 2*cos(1.5*pi*floor(Global.Evaluated/Global.T)/Global.nt) ... 
                        *sin(0.5*pi*floor(Global.Evaluated/Global.T)/Global.nt)+2;
            b  = 2*cos(1.5*pi*floor(Global.Evaluated/Global.T)/Global.nt) ...
                        *cos(0.5*pi*floor(Global.Evaluated/Global.T)/Global.nt)+2;
